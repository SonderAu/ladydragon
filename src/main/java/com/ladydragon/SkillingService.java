...
@Slf4j
public class SkillingService implements ConsumableState {
    private final Map<String, Integer> skillXpMap;
    private transient final String playerName;

    public SkillingService(String playerName, Client client) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SkillingService)) return false;

        SkillingService other = (SkillingService) o;
        for (Skill skill : Skill.values()) {
